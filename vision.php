		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li class="dropdown">
				...
				<ul class="dropdown-menu">
					...
					<li class="active animated zoomInDown"><a href="vision"><b>Vision</b></a></li>
				</ul>
			</li>
			<li class="dropdown">
...
<div class="container" id="vision_content">
	<div class="row">
		<div class="col-md-12">
			<h1 class="animated zoomInUp slow text text-center">VISION</h1>

			<p class="animated zoomIn slow text text-justify">Be a leading provider of highly globally competetive graduates and to help students achieve their goals in life as well-rounded individuals with a sound mind and a sound body and be a functional service in the world.</p>
